...
export const skills = [
  {
    category: "Frontend",
    items: ["React", "TypeScript", "Angular", "Tailwind CSS", "Next.js"],
  },
  {
    category: "Backend",
    items: ["Java", "Python", "PostgreSQL", "Spring", "FastAPI"],
  },
  {
    category: "Tools",
    items: ["Gitlab", "Docker", "Kubernetes", "Terraform", "Linux"],
  },
];
...
export const credentials = [
  ...
  },
  {
    ...
    relatedSkills: ["Google Cloud", "GCP", "Kubernetes", "Cloud Functions"],
  },
  {
    ...
    relatedSkills: ["Kubernetes", "Docker", "Linux", "Cloud Native"],
  },
];
